  ...
  <div class="card-body" style="background-color: rgb(255, 255, 255)" >
     <div class="">
      <div class="mb-sm-0 row">
        <div class="col-md-4">
            <h5 class="card-title fw-semibold mb-3">Pengeluaran</h5>
    ...
    <div class="table-responsive">
        <table id="tablePengeluaran" class="table table-striped table-hover mt-5" >
        <thead>
            <tr>
            <th scope="col">No</th>
            <th scope="col">Tanggal</th>
            <th scope="col">Pemakaian Transaksi</th>
